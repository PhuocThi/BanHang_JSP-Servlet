	...
	<div class="container-fluid content">
		...
		<div class="row">
			...
			<div class="col-md-8" style="padding-left: 0; padding-right: 0;">
				<center style="font-size: 24px;font-weight: 500;padding-bottom: 30px;"><b>HÀNG ĐẶT MUA
				</b></center>
				<table class="table table-hover" align="center">
					...
					if(session.getAttribute("gh")!=null) {
						...
						//Hien thi ms,ts,gia,soluong, thanhtien
							...
							<tr>
								<td>
									<input type="checkbox" name="delete <%=i%>" value="<%=h.getMahang()%>" form="form-1">								
								</td>
...
<!-- 								</td> -->
								...
								<div class="container-fluid">
									<div class="row">
										<div class="col-md-6">				
												<form action="suaController?mh=<%=h.getMahang()%>&sl=<%=h.getSoluongmua() %>" method="post">
													<input type="number" name="txtsl" min=0 style="width: 50px">
													<input type="submit" name="bu1" value="Sửa" class="btn-link"
									...
									<div class="col-md-6">
										<a href="xoaController?mh=<%=h.getMahang()%>&sl=<%=h.getSoluongmua() %>" 
											style="text-decoration: none;">
										Xóa</a>
									</div>		
						...
						<tr>
							...
							<td colspan="5" align="right"><b>Tổng tiền : <%=gh.Tong() %> đ</b></td>
							<% } %>
						</tr>
					<% } %>
				...
				<% if(session.getAttribute("dem")!=null) { %>
					...
					<div style="display:flex; flex-direction:row; gap:20px;">
						...
						<form action="xoaallController">
							<input type="submit" value="Xóa tất cả" class="btn-primary">
						</form>
						<form  action="xoadachonController" method="post" id="form-1">
								<input type="submit" value="Xóa đã chọn" class="btn-primary">
						</form>
						<form action="xacnhanController" method="post">
							<input type="submit" value="Xác nhận mua" class="btn-primary" name="b1">
						</form>
					</div>
					<% } else { out.print("<br> Bạn chưa đặt mua sản phẩm nào"); }
				 } else { out.print("<br>Bạn chưa đặt mua sản phẩm nào"); }%>
